...
<script async='async' src='https://platform-api.sharethis.com/js/sharethis.js#property=650b24671ce1b90012e5d84e&amp;product=sop' type='text/javascript'/>
<head>
  <style>
.footer-inner.shad {
  border-top: none;
 ...
 <style>
  /* Rimuove margini e padding tra le immagini */
  #main-sidebar .widget img {
      margin: 0 !important; /* Rimuove margine */
      padding: 0 !important; /* Rimuove padding */
      display: inline-block; /* Allinea le immagini sulla stessa riga */
      vertical-align: middle; /* Allinea le immagini in verticale */
  }

  /* Riduce lo spazio tra i widget */
  #main-sidebar .widget {
      margin-bottom: 2px !important; /* Riduce lo spazio sotto ogni widget */
      padding-bottom: 0 !important; /* Rimuove padding aggiuntivo sotto ogni widget */
  }

  /* Aggiungi questa regola per ridurre lo spazio tra le immagini e i loro contenitori */
  #main-sidebar .widget &gt; a {
      margin-right: 5px !important; /* Riduce lo spazio a destra tra le immagini */
      margin-bottom: 0 !important; /* Riduce lo spazio sotto le immagini */
  }

  /* Rimuove margini e padding extra dai contenitori dei widget */
  #main-sidebar .widget {
      margin: 0 !important; /* Rimuove margini aggiuntivi nei widget */
      padding: 0 !important; /* Rimuove padding aggiuntivo nei widget */
  }
</style>
...
<noscript><link href='https://use.fontawesome.com/releases/v5.10.0/css/v4-shims.css' rel='stylesheet'/></noscript>
	...
	<b:loop values='{   &quot;//1.bp.blogspot.com&quot;,   &quot;//28.2bp.blogspot.com&quot;,   &quot;//3.bp.blogspot.com&quot;,   &quot;//4.bp.blogspot.com&quot;,   &quot;//www.blogger.com&quot;,   &quot;//maxcdn.bootstrapcdn.com&quot;,   &quot;//fonts.googleapis.com&quot;,   &quot;//use.fontawesome.com&quot;,   &quot;//ajax.googleapis.com&quot;,   &quot;//resources.blogblog.com&quot;,   &quot;//www.facebook.com&quot;,   &quot;//plus.google.com&quot;,   &quot;//twitter.com&quot;,   &quot;//www.youtube.com&quot;,   &quot;//feedburner.google.com&quot;,   &quot;//www.pinterest.com&quot;,   &quot;//www.linkedin.com&quot;,   &quot;//www.behance.net&quot;,   &quot;//feeds.feedburner.com&quot;,   &quot;//github.com&quot;,   &quot;//player.vimeo.com&quot;,   &quot;//platform.twitter.com&quot;,   &quot;//apis.google.com&quot;,   &quot;//connect.facebook.net&quot;,   &quot;//cdnjs.cloudflare.com&quot;,   &quot;//www.google-analytics.com&quot;,   &quot;//pagead2.googlesyndication.com&quot;,   &quot;//googleads.g.doubleclick.net&quot;,   &quot;//www.gstatic.com&quot;,   &quot;//www.googletagservices.com&quot;,   &quot;//static.xx.fbcdn.net&quot;,   &quot;//tpc.googlesyndication.com&quot;,   &quot;//syndication.twitter.com&quot;,   &quot;//w.sharethis.com&quot;,   &quot;//edge.sharethis.com&quot;,   &quot;//t.sharethis.com&quot;,   &quot;//x.disq.us&quot;,   &quot;//s7.addthis.com&quot;}' var='link'><link expr:href='data:link' rel='dns-prefetch'/></b:loop>
...
<b:if cond='data:view.isPreview'>
	<!-- 
	Old preview condition check: 
	data:blog.pageType == &quot;item&quot; and data:blog.url == data:blog.homepageUrl 
	-->
...
<b:else/>
	...
	<script async='async' src='https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js' type='text/javascript'/>
	...
	<b:comment>
	<!-- don't need to provide og:title and og:description manually, 
	header tag will do that -->
	<b:if cond='data:blog.pageType == &quot;index&quot;'>
	...
	<b:if cond='data:blog.postImageUrl != &quot;&quot;'>		
		<meta expr:content='resizeImage(    data:blog.postImageUrl, 600, &quot;600:315&quot;   )' property='og:image'/>
		...
		<link as='image' expr:href='data:blog.postImageUrl' rel='preload'/>
	</b:if>
...
<b:else/>
&lt;meta property=&#39;fb:app_id&#39; content=&#39;<b:if cond='false'><!--facebook-app-id-start--></b:if>148720979503<b:if cond='false'><!--facebook-app-id-end--></b:if>&#39;/&gt;
</b:if>

&lt;script type=&#39;text/javascript&#39;&gt;var FACEBOOK_APP_ID = &#39;<b:if cond='false'><!--facebook-app-id-start--></b:if>148720979503<b:if cond='false'><!--facebook-app-id-end--></b:if>&#39;;&lt;/script&gt;
</b:if>
...
=======================
<Variable name="keycolor" description="Main Color" type="color" default="#FF3D00" value="#00cccc"/>

<Group description="Site" selector="body">
	 <Variable name="body.font" description="Font" type="font" default="normal normal 12px 'Roboto', sans-serif" value="normal normal 15px Allerta"/>
	 <Variable name="body.text.color" description="Text Color" type="color" default="#000000" value="#000000"/>
</Group>

<Group description="Backgrounds" selector="body">
	 <Variable name="body.background.color" description="Body Background" type="color" default="#efefef" value="#ffffff"/>
	 <Variable name="content.background.color" description="Entire Blog Background" type="color" default="#efefef" value="#ffffff"/>
	 <Variable name="header.background.color" description="Header Background" type="color" default="#ffffff" value="#ffffff"/> 
</Group>

<Group description="Menu" selector="#PageList1">
	<Variable name="menufont" description="Menu Main Items Font" type="font" default="normal bold 14px 'Roboto', sans-serif" value="normal normal 15px Luckiest Guy"/>
	<Variable name="menucolor" description="Menu Main Items Color" type="color" default="#000000" value="#00cccc"/>
	<Variable name="menucolorhover" description="Menu Main Items Hover Color" type="color" default="#777777" value="#3f3f3f"/>
	<Variable name="menubackground" description="Menu Main Items Background" type="color" default="#ffffff" value="#ffffff"/>
	<Variable name="menubackgroundhover" description="Menu Main Items Hover Background" type="color" default="#ffffff" value="#00cccc"/>

	<Variable name="menusubcolor" description="Menu Sub Items Color" type="color" default="#cccccc" value="#ffffff"/>
	<Variable name="menusubcolorhover" description="Menu Sub Items Hover Color" type="color" default="#ffffff" value="#ffffff"/>
	<Variable name="menusubbackground" description="Menu Sub Items Background" type="color" default="#333333" value="#00cccc"/>

	<Variable name="menucurcolor" description="Selected Menu Main Item Color" type="color" default="#FFFFFF" value="#ffffff"/>
	<Variable name="menucurbackground" description="Selected Menu Main Item Background" type="color" default="#FF3D00" value="#fe66cb"/>
</Group>

<Group description="Links" selector="body">
	 <Variable name="link.color" description="Link Color" type="color" default="$(keycolor)" value="#00cccc"/>
	 <Variable name="link.visited.color" description="Visited Color" type="color" default="#EA3A00" value="#00cccc"/>
	 <Variable name="link.hover.color" description="Hover Color" type="color" default="#FF4D11" value="#fe66cb"/>
</Group>

<Group description="Widgets - Gadgets" selector="#primary .widget">
	<Variable name="blockitembghv" description="Background of Items in Blocks when Hover" type="color" default="#000000" value="#ffffff"/>
	 <Variable name="feedwid.title.font" description="Article Widgets Title" type="font" default="normal bold 23px 'Roboto', sans-serif" value="normal 22px Luckiest Guy"/>
	 <Variable name="sidewid.title.font" description="Right Sidebar Widgets Title" type="font" default="normal normal 16px 'Roboto', sans-serif" value="normal 15px Luckiest Guy"/>
</Group>

<Group description="Post" selector="h1.post-title">
	<Variable name="post.title.font" description="Post Title" type="font" default="normal normal 40px 'Roboto', sans-serif" value="normal 20px Luckiest Guy"/>
...
<Group description="Slider" selector=".widget.slider">
	 <Variable name="slider.title.font" description="Slider Item Title" type="font" default="normal 400 30px 'Roboto', sans-serif" value="normal 400 30px &#39;Roboto&#39;, sans-serif"/>
</Group>
...
/*Variable Apply Here*/
body {font: $(body.font);color: $(body.text.color);background: $(body.background);$(body.background.override)}
...
.header-bg {background-color:$(header.background.color);}
...
.main-menu ul.sub-menu li:hover > a {border-left: 2px solid $(keycolor)o;}
...
a.comments-title.active {border-bottom: 2px solid $(content.background.color)!important;}
...
.feed.widget .thumbnail { background: $(blockitembghv)!important; }
.mobile-menu .menu { border-top: 1px solid $(keycolor); }
.slider-item .item-title {font:$(slider.title.font)}
form a[class*="button"], form button[class*="button"], form input[class*="button"], form input[type="submit"]{background:$(keycolor)!important}
/*MAIN LAYOUT*/
.main-loader {
    position: fixed;    
    width: 100%;
...
<!--[if lt IE 9]>
<style type="text/css">
.main-menu ul.menu li a i.fa {margin-right:3px;}
...
.widget.social_icons {display: none!important}
#footer .FollowByEmail .follow-by-email-address,
#main-sidebar .widget.FollowByEmail .follow-by-email-address {padding: 5px!important;width: 100px}
#footer .FollowByEmail {height: 90px}
</style>
<![endif]-->
...
<!--[if lt IE 9]>
<style type="text/css">
.main-menu ul.menu li a i.fa {margin-left:3px;}
.post-body-inner img {diplay:block;min-width: 300px;width:100%}
</style>
<![endif]-->
...
.search-thumbnail {
    width: 100%;
    height: 0;
    padding-top: 100%; /* Questo rende il contenitore quadrato */
    position: relative;
    overflow: hidden;
}
	...
	<b:else/>		
		<!--main-loader-start--><b:with value='&quot;&quot;' var='loading_image'><!--main-loader-end-->
			<b:if cond='data:loading_image'>
				<div class='main-loader'><div class='inner'><img alt='Loading ...' expr:src='data:loading_image' height='95' width='95'/></div></div>
			</b:if>
		</b:with>		
	</b:if>
...
<b:if cond='false'><!--amp-enabled-start--></b:if><b:if cond='false and data:blog.pageType in {&quot;static_page&quot;,&quot;item&quot;} and data:blog.isMobileRequest'><b:if cond='false'><!--amp-enabled-end--></b:if>
<b:else/>
<b:section class='hide' expr:name='data:blog.url != data:blog.homepageUrl? &quot;&quot; : &quot;Admin Header Custom Code (HTML / JavaScript / CSS)&quot;' id='admin-header-custom-html-code' maxwidgets='1' showaddelement='no'>
  <b:widget id='HTML100' locked='false' title='Only for Admin' type='HTML' version='1'>
    <b:widget-settings>
      <b:widget-setting name='content'><![CDATA[<style>
.post-body blockquote {
    background-color: #df46a9
}
...
<b:if cond='false'><!--amp-enabled-start--></b:if><b:if cond='false and data:blog.pageType in {&quot;static_page&quot;,&quot;item&quot;} and data:blog.isMobileRequest'><b:if cond='false'><!--amp-enabled-end--></b:if>
	<a class='amp-logo' expr:href='data:blog.homepageUrl'>
		<data:blog.title/>					
	</a>
	<a class='amp-redirect' expr:href='data:blog.url + &quot;?m=0&quot;'>
		<span data-l10n='VIEW NON-AMP VERSION'>VIEW NON-AMP VERSION</span>
	</a>
<b:else/>

	<!--top-bar--><b:if cond='false'><!--top-bar-->
		<div class='top-bar'><div class='clear'/></div>
	</b:if>
	...
	<b:else/>
		...
		<b:section expr:name='data:blog.url != data:blog.homepageUrl? &quot;&quot; : &quot;Page Top&quot;' id='top-page' maxwidgets='1'/>
	...
	<b:section class='shad header-bg' expr:name='data:blog.url != data:blog.homepageUrl? &quot;&quot; : &quot;Header&quot;' id='header-section' maxwidgets='3' showaddelement='no'>
<b:widget id='Header1' locked='true' title='EneRgiA CReatiVA (Intestazione)' type='Header' version='1'>
  <b:widget-settings>
    <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgalbgjclNySpDSmb6GmG9QH0Y4nORFGRwKt_dzePw51lZ-3GRXVto7D_ry-cGkQ3Jdmm9csbOAl_WffS_R6gNny4CzJnU8wCql9PoEUCeUqNHvmnwjXzG1gRxAlglHvyWjh4Y-pUwdgsN_WEDmLBSBy58eor0DFZyVrFj3bF-Hquzk31lGp97_nrgFR5c/s1600/PAOLA%20BONAVOLONTA%20PERSONAL%20BRANDING%20CREATIVO%20ESPERIENZIALE.jpg</b:widget-setting>
  ...
  <b:includable id='main'>				
				<a class='main-menu-toggle header-button toggle-button active' id='main-menu-toggle'><span class='inner'><i class='fa fa-bars color'/> <span data-l10n='MENU'>MENU</span></span><span class='arrow border'/></a>
				<a class='main-menu-toggle header-button toggle-button mobile' id='main-menu-toggle-mobile'><span class='inner'><i class='fa fa-bars color'/> <span data-l10n='MENU'>MENU</span></span><span class='arrow border'/></a>
				...
				<!--show_search--><b:if cond='true'><!--show_search--><a class='header-button' id='search-toggle'><span class='inner'><span data-l10n='SEARCH'>Cerca</span> <i class='fa fa-search color'/></span></a></b:if>
				<!--show_social--><b:if cond='true'><!--show_social--><div class='header-social-icons'/></b:if>
...
<b:widget id='PageList1' locked='true' title='MAIN MENU' type='PageList' version='1'>
  <b:widget-settings>
    ...
    <b:widget-setting name='homeTitle'>Home page</b:widget-setting>
  </b:widget-settings>
  <b:includable id='main'>						
				
			<!--MAGONE-MAIN-MENU-LOCATION-START--><ul class='menu'>
  <li><a href='https://www.energiacreativa.org/'>Home</a></li>
  <li><a href='http://www.energiacreativa.org/p/marketing.html'>Personal Branding</a></li>
  <li><a href='http://www.energiacreativa.org/p/counseling.html'>Counseling</a></li>
  <li><a href='http://www.energiacreativa.org/p/painting.html'>Painting</a></li>
  <li>
    <a href='https://www.energiacreativa.org/p/corsi-e-laboratori.html'>Prossimi corsi e laboratori</a>
    <ul class='sub-menu'>
      <li><a href='https://www.energiacreativa.org/search/label/laboratori'>Laboratori</a></li>
      <li><a href='https://www.energiacreativa.org/p/foto-laboratori.html'>Foto</a></li>
    </ul>
  </li>
  <li>
    <a href='https://www.energiacreativa.org/p/contatti-e-cv.html'>Contatti e cv</a>
    <ul class='sub-menu'>
      <li><a href='https://www.energiacreativa.org/p/catalogo-corsi-e-laboratori.html'>Lavora con me</a></li>
      <li><a href='https://www.energiacreativa.org/p/dicono-di-me.html'>Dicono di me</a></li>
    </ul>
  </li>
</ul>
<!--MAGONE-MAIN-MENU-LOCATION-END-->
			</b:includable>
</b:widget>
<b:widget id='LinkList1' locked='true' title='Header$type=social_icons' type='LinkList'>
  <b:widget-settings>
    <b:widget-setting name='shownum'>4</b:widget-setting>
    <b:widget-setting name='link-3'>#</b:widget-setting>
    <b:widget-setting name='sorting'>NONE</b:widget-setting>
    <b:widget-setting name='link-4'>#</b:widget-setting>
    <b:widget-setting name='text-1'>_POST FORMAT</b:widget-setting>
    <b:widget-setting name='link-1'>https://holiday-themexpose.blogspot.com/p/post-format-and-page-markup.html</b:widget-setting>
    <b:widget-setting name='text-0'>Features</b:widget-setting>
    <b:widget-setting name='link-2'>https://holiday-themexpose.blogspot.com/themexpose</b:widget-setting>
    <b:widget-setting name='text-3'>Trending</b:widget-setting>
    <b:widget-setting name='link-0'>http://</b:widget-setting>
    <b:widget-setting name='text-2'>_Error Page</b:widget-setting>
...
<div id='primary'>	
	<b:if cond='false'><!--amp-enabled-start--></b:if><b:if cond='false and data:blog.pageType in {&quot;static_page&quot;,&quot;item&quot;} and data:blog.isMobileRequest'><b:if cond='false'><!--amp-enabled-end--></b:if>
	<b:else/>
		<b:section class='clear' expr:name='data:blog.url != data:blog.homepageUrl? &quot;&quot; : &quot;Header Wide&quot;' id='header-wide'>
<b:widget id='Image5' locked='false' title='' type='Image'>
  <b:widget-settings>
    <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjlkM_4G5PChBwQUuIAFsivz_EGikaD5P59MLsBAC-O41ZALpsOerFKvHRyKyefR17dngSsC6bvjSPxwEy6lgJkJhEAlyVYqs6oTcmbv9dU6hbsWAOM1VRvKpoyUjSzEq8KuDvygJCNPzHzPXpXBCXVG-6NCpx5qLxzJnD5Pgm16a2AkSN0MGjlRnyqoq8/s640/23%20Paola%20Bonavolont%C3%A0%20Personal%20Branding%20creativo%20lk.jpg</b:widget-setting>
    <b:widget-setting name='displayHeight'>160</b:widget-setting>
    <b:widget-setting name='sectionWidth'>150</b:widget-setting>
    <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
    <b:widget-setting name='displayWidth'>640</b:widget-setting>
    <b:widget-setting name='link'>https://www.energiacreativa.org/</b:widget-setting>
...
<b:widget id='HTML17' locked='false' title='$type= disable copy paste' type='HTML'>
  <b:widget-settings>
    <b:widget-setting name='content'><![CDATA[<!- start disable copy paste --><script src='demo-to-prevent-copy-paste-on-blogger_files/googleapis.js'></script><script type='text/javascript'> if(typeof document.onselectstart!="undefined" ) {document.onselectstart=new Function ("return false" ); } else{document.onmousedown=new Function ("return false" );document.onmouseup=new Function ("return false"); } </script><!-- End disable copy paste --></!->]]></b:widget-setting>
  </b:widget-settings>
  <b:includable id='main'>
...
<b:widget id='Label0' locked='false' title='$type=ticker$cols=4' type='Label'>
  <b:widget-settings>
  ...
  <div expr:class='&quot;widget-content &quot; + data:display + &quot;-label-widget-content&quot;'>
	...
	<div id='content'>
		...
		<b:if cond='false'><!--amp-enabled-start--></b:if><b:if cond='false and data:blog.pageType in {&quot;static_page&quot;,&quot;item&quot;} and data:blog.isMobileRequest'><b:if cond='false'><!--amp-enabled-end--></b:if>
		<b:else/>
			<b:section expr:name='data:blog.url != data:blog.homepageUrl? &quot;&quot; : &quot;All Pages Content Top&quot;' id='content-section-wide-top'/>
		</b:if>

		<b:if cond='data:blog.url == data:blog.homepageUrl and data:blog.pageType == &quot;index&quot;'>
			<b:section id='content-section-1' name='Home Only Content'>
<b:widget id='Label5' locked='false' title='$type=three$h=200$c=24$m=hide$rm=hide$$pages=show$t=oot$l=hide' type='Label'>
  <b:widget-settings>
    <b:widget-setting name='sorting'>ALPHA</b:widget-setting>
    <b:widget-setting name='display'>LIST</b:widget-setting>
    <b:widget-setting name='selectedLabelsList'/>
...
<b:widget id='Label2' locked='false' title='Personal Branding$type=three$count=3$author=hide$comment=hide$rm=hide$date=0$h=200$comment=$t=oot' type='Label'>
  <b:widget-settings>
    <b:widget-setting name='sorting'>ALPHA</b:widget-setting>
    <b:widget-setting name='display'>LIST</b:widget-setting>
    <b:widget-setting name='selectedLabelsList'>personal branding</b:widget-setting>
...
<b:widget id='Label6' locked='false' title='ARTcounseling$type=three$count=3$author=hide$comment=hide$rm=hide$date=0$h=200$comment=$t=oot' type='Label'>
  <b:widget-settings>
    <b:widget-setting name='sorting'>ALPHA</b:widget-setting>
    <b:widget-setting name='display'>LIST</b:widget-setting>
    <b:widget-setting name='selectedLabelsList'>artcounseling</b:widget-setting>
    <b:widget-setting name='showType'>USER_SELECTED</b:widget-setting>
    <b:widget-setting name='showFreqNumbers'>false</b:widget-setting>
  </b:widget-settings>
  <b:includable id='main'>
...
<b:widget id='Label9' locked='false' title='Crescita$type=three$count=3$author=hide$comment=hide$rm=hide     $date=0$author=0$comment=$t=oot' type='Label'>
  <b:widget-settings>
    <b:widget-setting name='sorting'>ALPHA</b:widget-setting>
    <b:widget-setting name='display'>LIST</b:widget-setting>
    <b:widget-setting name='selectedLabelsList'>crescita</b:widget-setting>
    <b:widget-setting name='showType'>USER_SELECTED</b:widget-setting>
    <b:widget-setting name='showFreqNumbers'>false</b:widget-setting>
  </b:widget-settings>
  <b:includable id='main'>
...
<b:widget id='Label10' locked='false' title='Laboratori$type=three$count=3$author=hide$comment=hide$rm=hide     $date=0$author=0$comment=$t=oot' type='Label'>
  <b:widget-settings>
    <b:widget-setting name='sorting'>ALPHA</b:widget-setting>
    <b:widget-setting name='display'>LIST</b:widget-setting>
    <b:widget-setting name='selectedLabelsList'>laboratori</b:widget-setting>
    <b:widget-setting name='showType'>USER_SELECTED</b:widget-setting>
    <b:widget-setting name='showFreqNumbers'>false</b:widget-setting>
  </b:widget-settings>
  <b:includable id='main'>
  ...
  <div expr:class='&quot;widget-content &quot; + data:display + &quot;-label-widget-content&quot;'>
    ...
    <b:include name='quickedit'/>
		...
		<b:section expr:name='data:blog.url != data:blog.homepageUrl? &quot;&quot; : &quot;All Pages Content Middle&quot;' id='content-section-2' maxwidgets='3' showaddelement='no'>
<b:widget id='HTML4' locked='true' title='Archive Pages Design$type=blogging$count=7$date=hide$author=hide$comment=hide' type='HTML' version='1'>
  <b:widget-settings>
...
<b:widget id='Blog1' locked='true' title='Post del blog' type='Blog' version='1'>
  <b:widget-settings>
    <b:widget-setting name='commentLabel'>comments</b:widget-setting>
    <b:widget-setting name='showShareButtons'>true</b:widget-setting>
    <b:widget-setting name='authorLabel'>Paola BonavolontÃ </b:widget-setting>
  ...
  <b:includable id='main' var='top'>
					<b:if cond='false'><!--amp-enabled-start--></b:if><b:if cond='false and data:blog.pageType in {&quot;static_page&quot;,&quot;item&quot;} and data:blog.isMobileRequest'><b:if cond='false'><!--amp-enabled-end--></b:if>
						<b:loop values='data:posts' var='post'>
							<b:include data='post' name='amp-post'/>
						</b:loop>
					<b:else/>
						<b:if cond='data:blog.pageType in {&quot;static_page&quot;,&quot;item&quot;}'>
							<!-- posts -->						
								...
								<b:loop values='data:posts' var='post'>
									...
									<div class='post-outer'>
										<b:if cond='data:blog.pageType == &quot;item&quot;'>
											...
											<b:include name='amp-replace'/>
										<b:elseif cond='data:blog.pageType == &quot;static_page&quot;'/>
											<b:include data='post' name='post-page'/>
											<b:include name='amp-replace'/>
										</b:if>
										...
										<b:include cond='data:post.allowComments and data:blog.pageType in {&quot;static_page&quot;,&quot;item&quot;}' data='post' name='comments'/>
									</div>
  ...
  <b:includable id='amp-ads-1'>
					<!--amp-ad-client-start--><b:with value='&quot;&quot;' var='amp_ad_client'><!--amp-ad-client-end-->
						<b:if cond='data:amp_ad_client'>
							<!--amp-ad-slot-1-start--><b:with value='&quot;&quot;' var='amp_ad_slot_1'><!--amp-ad-slot-1-end-->
								<b:if cond='data:amp_ad_slot_1'>					
						&lt;amp-ad data-ad-client=&quot;<data:amp_ad_client/>&quot; data-ad-slot=&quot;<data:amp_ad_slot_1/>&quot; layout=&quot;fixed-height&quot; height=100 type=&quot;adsense&quot;&gt;&lt;/amp-ad&gt;		</b:if>
							</b:with>
						</b:if>
					</b:with>			
				</b:includable>
  <b:includable id='amp-ads-2'>
					<!--amp-ad-client-start--><b:with value='&quot;&quot;' var='amp_ad_client'><!--amp-ad-client-end-->
						<b:if cond='data:amp_ad_client'>
							<!--amp-ad-slot-2-start--><b:with value='&quot;&quot;' var='amp_ad_slot_2'><!--amp-ad-slot-2-end-->
								<b:if cond='data:amp_ad_slot_2'>						
						&lt;amp-ad data-ad-client=&quot;<data:amp_ad_client/>&quot; data-ad-slot=&quot;<data:amp_ad_slot_2/>&quot; layout=&quot;fixed-height&quot; height=100 type=&quot;adsense&quot;&gt;&lt;/amp-ad&gt;		</b:if>
							</b:with>
						</b:if>
					</b:with>			
				</b:includable>
  <b:includable id='amp-ads-3'>
					<!--amp-ad-client-start--><b:with value='&quot;&quot;' var='amp_ad_client'><!--amp-ad-client-end-->
						<b:if cond='data:amp_ad_client'>
							<!--amp-ad-slot-3-start--><b:with value='&quot;&quot;' var='amp_ad_slot_3'><!--amp-ad-slot-3-end-->
								<b:if cond='data:amp_ad_slot_3'>
						&lt;amp-sticky-ad layout=&quot;nodisplay&quot;&gt;
						&lt;amp-ad data-ad-client=&quot;<data:amp_ad_client/>&quot; data-ad-slot=&quot;<data:amp_ad_slot_3/>&quot; layout=&quot;fixed-height&quot; height=100 type=&quot;adsense&quot;&gt;&lt;/amp-ad&gt;
						&lt;/amp-sticky-ad&gt;
								</b:if>
							</b:with>
						</b:if>
  ...
  <b:includable id='amp-post' var='post'>					
					<b:include name='amp-ads-1'/>
					<h1><data:post.title/></h1>
					<b:include name='amp-ads-2'/>
					<div class='post-body'><data:post.body/></div>
					<b:include name='amp-ads-3'/>
				</b:includable>
  <b:includable id='amp-replace'>
  ...
  <b:includable id='blogger-comments' var='post'>
					<div class='blogger-comments comments'>
						<a class='blogger-comments-title comments-title' data-target='.blogger-comments' expr:data-comment_number='data:post.numComments' href='javascript:void(0)'>			
							<b:if cond='data:post.commentSource == 1'>
								 <span data-l10n='GOOGLE+'>GOOGLE+</span>								 
							<b:else/>
								<b:if cond='data:post.numComments == 0'>
									<span data-l10n='BLOGGER'>BLOGGER</span>
								<b:else/>
									<span data-l10n='BLOGGER'>BLOGGER</span>: <span class='color'><data:post.numComments/></span>
								</b:if>							
							</b:if>							
						</a>
						...
						<b:if cond='data:post.commentSource == 1'>
							<b:include data='post' name='google-plus-comments'/>
						<b:else/>
							<div class='blogger-comments-inner comments-inner'>
								<b:if cond='data:post.numComments != 0'>
									<div class='blogger-comments-holder comments-holder'>
										<b:if cond='data:post.commentJso and data:post.commentJso != &quot;null&quot;'>
								...
								<b:if cond='data:post.numComments == 0 or data:post.commentJso and data:post.commentJso != &quot;null&quot;'>
									<div class='blogger-comment-footer'>
										<b:if cond='data:post.embedCommentForm'>
											<b:if cond='data:post.allowNewComments'>
												<b:include data='post' name='comment-form'/>
											<b:else/>
												<span class='noNewComments'><data:post.noNewCommentsText/></span>
											</b:if>
								...
								<b:if cond='data:post.numComments != 0'>
									...
									<b:if cond='data:post.commentJso and data:post.commentJso != &quot;null&quot;'>
										<script type='text/javascript'>
											var COMMENT_ITEMS = <data:post.commentJso/> ;
										</script>																			
									</b:if>
								</b:if>
							</div>
  ...
  <b:includable id='comment-form' var='post'>
					<div class='comment-form-add-new'>
						<div class='comment-form-wrapper'>
							<a class='comment-editor-src' expr:data-src='data:post.commentFormIframeSrc' name='comment-form'/>
							<b:if cond='data:blogCommentMessage'>
								<div class='comment-form-message'><data:blogCommentMessage/></div>
							</b:if>
							<iframe allowtransparency='true' class='blogger-iframe-colorize blogger-comment-from-post' expr:src='data:post.commentFormIframeSrc' frameborder='0' height='410' id='comment-editor' name='comment-editor' style='margin: -1px 0 0 -8px;max-width: none;width: 102.5%;position: relative;z-index: 0; max-height: 410px'/>						
						</div>
					</div>
				</b:includable>
  ...
  <b:includable id='commentItem' var='comment'>
					...
					<li class='comment' expr:id='&quot;c&quot; + data:comment.id'>
						...
						<div class='avatar-image-container'>
							<img alt='' class='shad cir' expr:src='data:comment.authorAvatarSrc'/>
						</div>
						<!--</b:if>-->
  ...
  <b:includable id='comments' var='post'>
					<div id='comments'>
						<div id='comments-title-tabs'>
							<h4 class='post-section-title comments-title-tabs-name comments-title-tab'><i class='fa fa-comments'/> <span data-l10n='COMMENTS'>Commenti</span></h4>
						</div>
						<div class='clear'/>
						<div class='comments-title-tabs-hr'/>
						<a name='comments'/>

						<!--var-enable-blogger-comment--><b:if cond='true'><!--var-enable-blogger-comment-->
							<b:include data='post' name='blogger-comments'/>
						</b:if>

						<b:if cond='data:blog.url != data:blog.homepageUrl'>
							<!--var-enable-facebook-comment--><b:if cond='true'><!--var-enable-facebook-comment-->
								<b:include data='post' name='facebook-comments'/>
							</b:if>
						</b:if>

						<!--var-enable-disqus-comment--><b:if cond='false'><!--var-enable-disqus-comment-->
  ...
  <b:includable id='facebook-comments' var='post'>
				

					<div class='facebook-comments comments'>
						<a class='facebook-comments-title comments-title' data-target='.facebook-comments' href='javascript:void(0)'>
							<span data-l10n='FACEBOOK'>FACEBOOK</span><b:comment>
												Temporary Disabled Until Found a Way to Get Facebook Count without Authentication: <span class='color'><span class='facebook-comments-count' expr:href='data:post.url'/></span></b:comment>
						</a>
						<div class='facebook-comments-inner comments-inner'>
							<b:if cond='false'>
							<div class='fb-comments' data-mobile='true' data-numposts='5' data-width='100%' expr:data-href='data:blog.canonicalUrl'/>
							
							<b:else/>
								<b:if cond='false'>
									<div class='fb-comments fb_iframe_widget' data-colorscheme='light' data-numposts='5' data-width='0' expr:data-href='data:blog.canonicalUrl' fb-xfbml-state='rendered' id='jsid-comment-facebook-plugin'/>
								<b:else/>
									<div class='fb-comments fb_iframe_widget' data-colorscheme='light' data-numposts='5' data-width='0' expr:data-href='data:blog.canonicalUrl' fb-xfbml-state='rendered' id='jsid-comment-facebook-plugin' width='100%'/>
								</b:if>
							</b:if>
  ...
  <b:includable id='google-plus-comments' var='post'>
					<div class='blogger-comments-inner comments-inner'>					
  ...
  <b:includable id='post-404'>
					<div class='post-404'>
						...
						<div class='link'>
							<a href='/'><i class='fa fa-car'/> <span data-l10n='Back Home'>Back Home</span></a>
						</div>
					</div>
				</b:includable>
  <b:includable id='post-item' var='post'>					
					...
					<div class='post hentry' itemprop='blogPost' itemscope='itemscope' itemtype='https://schema.org/BlogPosting'>
						...
						<div class='post-header'>
							<a class='post-id' expr:data-id='data:post.id' expr:name='data:post.id'/>
							

							<!--var-enable-breadcrumb--><b:if cond='false'><!--var-enable-breadcrumb-->								
								...
								<b:loop values='data:post.labels' var='label'>																		
									<span itemscope='' itemtype='https://schema.org/BreadcrumbList'>
										<span itemprop='itemListElement' itemscope='' itemtype='https://schema.org/ListItem'>
											<meta expr:content='data:label.url' itemprop='item'/>
											<meta expr:content='data:label.name' itemprop='name'/>
							...
							<b:if cond='data:post.title'>
								<h1 class='post-title entry-title' itemprop='name headline'><data:post.title/></h1>
								<!--var-enable-sub-title--><b:if cond='true'><!--var-enable-sub-title-->
									<div class='post-sub-title-wrapper'/>
								</b:if>
							</b:if>

							<!--var-enable-top-sharing-button--><b:if cond='false'><!--var-enable-top-sharing-button-->
							...
							<!-- meta data for post -->
							<b:if cond='data:post.dateHeader or data:top.showTimestamp or data:top.showAuthor or data:post.allowComments'>
								<div class='post-meta-wrapper'>
									<b:if cond='data:post.allowComments'>
										<a class='post-meta post-meta-comments' href='#comments'>
											<span class='blogger-comment-counter post-comment-counter'><i class='fa fa-comment-o'/> <data:post.numComments/></span>
											<b:comment>
												Temporary Disabled Until Found a Way to Get Facebook Count without Authentication
											<span class='facebook-comment-counter post-comment-counter'><i class='fa fa-comment-o'/> <span class='facebook-comments-count' expr:href='data:post.url'/></span>
											</b:comment>

											<span class='disqus-comment-counter post-comment-counter'><i class='fa fa-comment-o'/> <span class='disqus-comment-count' expr:data-disqus-url='data:post.url + &quot;#disqus_thread&quot;'>0</span></span>
										</a>
									</b:if>

									<b:if cond='data:top.showAuthor'>
										<a expr:class='&quot;author post-meta post-meta-author vcard &quot; + (data:post.authorProfileUrl ? &quot;g-profile&quot; : &quot;&quot;)' expr:href='data:post.authorProfileUrl ? data:post.authorProfileUrl : &quot;#post-author-link&quot;' id='post-author-link' rel='author' title='author profile'>
											<i class='fa fa-pencil-square-o'/> <span class='fn'><data:post.author/></span>
										</a>
									</b:if>

									<b:if cond='data:post.dateHeader or data:top.showTimestamp'>
										<a class='entry-date published post-meta post-meta-date timestamp-link' expr:data-dateHeader='data:post.dateHeader' expr:href='data:post.url' rel='bookmark' title='permanent link'>
											<i class='fa fa-clock-o'/>
											<abbr class='updated' expr:title='data:post.timestampISO8601' itemprop='datePublished dateModified'>
												<span class='value'><data:post.dateHeader/></span>
											</abbr>
										</a>
									</b:if>
									<b:include data='post' name='postQuickEdit'/>
						...
						<!-- Then use the post body as the schema.org description, for good G+/FB snippeting. -->
						<div class='post-body entry-content' expr:id='&quot;post-body-&quot; + data:post.id' expr:itemprop='(data:blog.metaDescription ? &quot;&quot; : &quot;description &quot;) + &quot;articleBody&quot;'>							
							<!--var-full-post-ads--><b:if cond='false'><!--var-full-post-ads-->
							&lt;div class=&quot;full-post-ads&quot;&gt;
							</b:if>
							<!--var-dis-ads-in-mob-start--><b:if cond='data:blog.isMobileRequest and true'><!--var-dis-ads-in-mob-end-->

							<b:else/>
							<!--var-enable-ads-in-post--><b:if cond='false'><!--var-enable-ads-in-post-->
									<div class='post-ads'>									
									</div>
							</b:if>
							</b:if>
							<div class='post-right'>
								<!--var-enable-excerpt--><b:if cond='false'><!--var-enable-excerpt-->
										<p class='post-excerpt'>
											<b:if cond='data:blog.metaDescription'>
												<data:blog.metaDescription/>
											<!--var-enable-alt-excerpt--><b:elseif cond='true'/><!--var-enable-alt-excerpt-->
												<data:post.snippet/>
											</b:if>
										</p>
								</b:if>
								<!--var-enable-post-break-links--><b:if cond='false'><!--var-enable-post-break-links-->
							...
							<div style='clear: both;'/>
							<div class='post-body-inner'><data:post.body/></div>
							<div class='clear'/>
							<!--var-enable-post-pagination--><b:if cond='true'><!--var-enable-post-pagination-->
						...
						<div class='after-post-content-after-body'/>

						<div class='post-footer'>							
							<b:if cond='data:top.showPostLabels and data:post.labels'>
								<div class='post-labels post-section'>
									<b:if cond='data:postLabelsLabel in {&quot;0&quot;,&quot; &quot;,&quot;none&quot;,&quot;hide&quot;,&quot;false&quot;}'>
									<b:else/>
									...
									<b:loop values='data:post.labels' var='label'>
									<a class='post-label' expr:href='data:label.url' rel='tag'>
										<span class='bg label-name'><data:label.name/></span>
							...
							<b:if cond='data:top.showReactions'>								
								<div class='reactions-table post-section'>
									<b:if cond='data:top.reactionsLabel'>
										<h4 class='post-section-title'>
							...
							<b:if cond='data:top.showLocation and data:post.location'>
								<div class='post-location post-section'>
									<h4 class='post-section-title'><i class='fa fa-crosshairs'/> <data:postLocationLabel/></h4>
									<a expr:href='data:post.location.mapsUrl' target='_blank'><data:post.location.name/></a>
									<div class='clear'/>
								</div>
								<div class='clear'/>
							...
							<b:if cond='data:post.authorAboutMe'>
								<div class='post-section post-author-box' itemprop='author' itemscope='itemscope' itemtype='https://schema.org/Person'>
									<h4 class='post-section-title'>
										<i class='fa fa-pencil-square'/> <span data-l10n='AUTHOR'/>
										<b:if cond='data:post.authorProfileUrl'>
											<a class='author-profile-link fn' expr:href='data:post.authorProfileUrl' itemprop='name' rel='nofollow' target='_blank' title='author profile'>
												<span><data:post.author/></span>
											</a>
										<b:else/>
											<strong title='author profile'><data:post.author/></strong>
										</b:if>
									</h4>
									<div class='clear'/>
									<div class='post-author-box-content'>
										<div expr:class='&quot;author-profile &quot; + (data:post.authorPhoto.url ? &quot;has-avatar&quot; : &quot;no-avatar&quot;)'>
											<b:if cond='data:post.authorPhoto.url'>
												<img alt='author-avatar' class='author-profile-avatar cir' expr:src='data:post.authorPhoto.url' height='50px' itemprop='image' width='50px'/>												
											<b:else/>
							...
							<!--var-enable-related-post--><b:if cond='true'><!--var-enable-related-post-->
						...
						<b:if cond='data:blog.postImageUrl'>
							<div class='hide' itemprop='image' itemscope='' itemtype='https://schema.org/ImageObject'>
							    <img class='hide' expr:src='data:blog.postImageUrl' itemprop='image'/>
							    <meta expr:content='data:blog.postImageUrl' itemprop='url'/>
					...
					<!--var-enable-nextprev--><b:if cond='false'><!--var-enable-nextprev-->
						<b:include name='nextprev'/>
					</b:if>
					<div class='after-post-content-before-comment'/>

					<b:loop values='data:post.labels' var='label'>
					<span class='post-label-data hide' expr:data-href='data:label.url'/>
					</b:loop>
				</b:includable>
  <b:includable id='post-page' var='post'>
					<div class='page post'>
						<div class='post-header'>
							<a class='post-id' expr:data-id='data:post.id' expr:name='data:post.id'/>							
  ...
  <b:includable id='postQuickEdit' var='post'>
					<b:with value='&quot;https://www.blogger.com/blog/post/edit/&quot; + data:blog.blogId + &quot;/&quot; + data:post.id' var='postEditUrl'>					
						<span expr:class='&quot;item-control &quot; + data:post.adminClass'>
							<a class='post-meta' expr:href='data:postEditUrl' expr:title='data:top.editPostMsg'>
							<i class='fa fa-pencil'/> <span><span data-l10n='Edit this post'>Edit this post</span></span>
							</a>
						</span>					
					</b:with>
				</b:includable>
  <b:includable id='shareButtons' var='post'>
					<div class='post-section post-share-buttons'>
						...
						<div class='post-share-buttons-holder'>
							&lt;!--[if !IE]&gt; --&gt;
							<!--share-buttons-code-start--><script type='text/javascript'>var addthis_config = addthis_config||{};addthis_config.data_track_addressbar = false;addthis_config.data_track_clickback = false;</script><script async='async' src='https://s7.addthis.com/js/200/addthis_widget.js#pubid=ra-4f98ab455ea4fbd4' type='text/javascript'/><div class='addthis_sharing_toolbox'/><!--share-buttons-code-end-->
							&lt;!-- &lt;![endif]--&gt;
							
							<div class='ie-sharing-buttons'>																	 	
							    &lt;a href=&quot;https://twitter.com/share?url=<data:post.url/>&amp;amp;text=Simple%20Share%20Buttons&amp;amp;hashtags=simplesharebuttons&quot; target=&quot;_blank&quot;&gt;
							        &lt;img src=&quot;https://1.bp.blogspot.com/-GCZgnTmPMBk/VdPrZ1MUYXI/AAAAAAAALt4/kDPp85Zxj3w/s1600/ie-share-twiiter.png&quot; alt=&quot;Twitter&quot; /&gt;
							    &lt;/a&gt;		
							    
							    &lt;a href=&quot;https://www.facebook.com/sharer.php?u=<data:post.url/>&quot; target=&quot;_blank&quot;&gt;
							        &lt;img src=&quot;https://2.bp.blogspot.com/-yhtupG4S4pY/VdPrZP56fII/AAAAAAAALto/tfRtn6o16JY/s1600/ie-share-facebook.png&quot; alt=&quot;Facebook&quot; /&gt;
							    &lt;/a&gt;							    
							    
							    &lt;a href=&quot;https://plus.google.com/share?url=<data:post.url/>&quot; target=&quot;_blank&quot;&gt;
						...
						<div class='clear'/>
						<!--var-share-url-start--><b:if cond='false'><!--var-share-url-start--><input class='post-share-buttons-url' expr:value='data:post.url'/></b:if>
						<div class='clear'/>		
					</div>
					<div class='clear'/>
  ...
  <b:includable id='threadedCommentForm' var='post'>
					<div class='comment-form'>
						...
						<iframe allowtransparency='allowtransparency' class='blogger-iframe-colorize blogger-comment-from-post' expr:height='data:cmtIframeInitialHeight ?: &quot;90px&quot;' expr:src='data:post.commentFormIframeSrc + &quot;&amp;skin=contempo&quot;' frameborder='0' id='comment-editor' name='comment-editor' width='100%'/>
						<data:post.cmtfpIframe/>
						<script type='text/javascript'>
							BLOG_CMT_createIframe(&#39;<data:post.appRpcRelayPath/>&#39;);
						</script>
					...
					<section class='comments threaded' expr:data-embed='data:post.embedCommentForm' expr:data-num-comments='data:post.numberOfComments' id='comments'>
						...
						<div class='comments-content'>
							...
							<div id='comment-holder'>
								<b:if cond='data:post.commentHtml and data:post.commentHtml != &quot;null&quot;'>
...
<b:widget id='HTML3' locked='true' title='TOP-LEFT ADS' type='HTML' version='1'>
  <b:widget-settings>
    <b:widget-setting name='content'/>
  </b:widget-settings>
  <b:includable id='main'><b:if cond='false'><!--amp-enabled-start--></b:if><b:if cond='false and data:blog.pageType in {&quot;static_page&quot;,&quot;item&quot;} and data:blog.isMobileRequest'><b:if cond='false'><!--amp-enabled-end--></b:if><b:remove/></b:if><b:if cond='data:blog.pageType in {&quot;static_page&quot;,&quot;item&quot;}'><b:else/><b:remove/></b:if><!--var-dis-ads-in-mob-start--><b:if cond='data:blog.isMobileRequest and true'><!--var-dis-ads-in-mob-end--><b:else/><data:content/></b:if></b:includable>
</b:widget>
<b:widget id='HTML13' locked='true' title='INNER POST ADS' type='HTML' version='1'>
  <b:widget-settings>
    <b:widget-setting name='content'/>
  </b:widget-settings>
  <b:includable id='main'><b:if cond='false'><!--amp-enabled-start--></b:if><b:if cond='false and data:blog.pageType in {&quot;static_page&quot;,&quot;item&quot;} and data:blog.isMobileRequest'><b:if cond='false'><!--amp-enabled-end--></b:if><b:remove/></b:if><b:if cond='data:blog.pageType in {&quot;static_page&quot;,&quot;item&quot;}'><b:else/><b:remove/></b:if><data:content/></b:includable>
</b:widget>
<b:widget id='HTML23' locked='true' title='INNER POST ADS 2' type='HTML' version='1'>
  <b:widget-settings>
    <b:widget-setting name='content'/>
  </b:widget-settings>
  <b:includable id='main'><b:if cond='false'><!--amp-enabled-start--></b:if><b:if cond='false and data:blog.pageType in {&quot;static_page&quot;,&quot;item&quot;} and data:blog.isMobileRequest'><b:if cond='false'><!--amp-enabled-end--></b:if><b:remove/></b:if><b:if cond='data:blog.pageType in {&quot;static_page&quot;,&quot;item&quot;}'><b:else/><b:remove/></b:if><data:content/></b:includable>
		...
		<b:else/>
			<b:if cond='data:blog.pageType == &quot;item&quot; or data:blog.url == data:blog.homepageUrl'>
				<b:section expr:name='data:blog.url != data:blog.homepageUrl? &quot;&quot; : &quot;After Post Body Content&quot;' id='content-section-after-post'/>
			</b:if>
			<b:section expr:name='data:blog.url != data:blog.homepageUrl? &quot;&quot; : &quot;All Pages Content Bottom&quot;' id='content-section-wide-bottom'/>
		<!-- end of AMP check-->
		</b:if>
	...
	<!--home-sidebar-manager--><b:with value='&quot;default&quot;' var='home_sidebar'><!--home-sidebar-manager-->
		<b:if cond='data:blog.pageType != &quot;item&quot;'><!--prevent preview pages-->
			<b:switch var='data:home_sidebar'>
				<b:case value='none'/>
	...
	<!--static_page-sidebar-manager--><b:with value='&quot;default&quot;' var='static_page_sidebar'><!--static_page-sidebar-manager-->
		<b:switch var='data:static_page_sidebar'>			
			<b:case value='none'/>
	...
	<!--item-sidebar-manager--><b:with value='&quot;default&quot;' var='item_sidebar'><!--item-sidebar-manager-->
		<b:switch var='data:item_sidebar'>			
			<b:case value='none'/>
	...
	<!--index-sidebar-manager--><b:with value='&quot;default&quot;' var='index_sidebar'><!--index-sidebar-manager-->
		<b:if cond='data:blog.url != data:blog.homepageUrl'>
			<b:switch var='data:index_sidebar'>			
				<b:case value='none'/>
	...
	<!--archive-sidebar-manager--><b:with value='&quot;default&quot;' var='archive_sidebar'><!--archive-sidebar-manager-->
		<b:switch var='data:archive_sidebar'>			
			<b:case value='none'/>
			...
			<b:case value='right'/>
				<style type='text/css'>body.archive #content{float:left;}body.archive #main-sidebar{float:right}</style>
			<b:default/>
		</b:switch>
	</b:with>
	<b:if cond='false'><!--amp-enabled-start--></b:if><b:if cond='false and data:blog.pageType in {&quot;static_page&quot;,&quot;item&quot;} and data:blog.isMobileRequest'><b:if cond='false'><!--amp-enabled-end--></b:if>	
	<b:else/>
		<div id='main-sidebar'>
		<b:section expr:name='data:blog.url != data:blog.homepageUrl? &quot;&quot; : &quot;Right Sidebar&quot;' id='sidebar'>
<b:widget id='HTML8' locked='false' title='$type=icone fbemailetc' type='HTML'>
  <b:widget-settings>
    <b:widget-setting name='content'><![CDATA[<div style="border-width: 0pt medium medium; text-align: center;">  <span style="color: #333333; font-size: 2rem; display: inline-flex; gap: 15px;">
        <a class="updown-inner collections-icon-facebook" href="https://www.facebook.com/paolabonavolonta" target="_blank">
            <i class="fa fa-facebook"></i>
        </a>
        <a class="updown-inner collections-icon-linkedin" href="https://www.linkedin.com/in/paolabonavolonta" target="_blank">
            <i class="fa fa-linkedin"></i>
        </a>
        <a class="updown-inner collections-icon-instagram" href="https://www.instagram.com/paola_bonavolonta/" target="_blank">
            <i class="fa fa-instagram"></i>
        </a>
        <a class="updown-inner collections-icon-skype" href="skype:paolabonavolonta?call" target="_blank">
    <i class="fa fa-skype"></i>
        </a>
<a class="fa fa-envelope"href="mailto:paola@energiacreativa.org" target="_blank">
    </a></span></div>]]></b:widget-setting>
  </b:widget-settings>
  <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
...
<b:widget id='HTML1' locked='false' title='$type=chi sono left$#259AA1' type='HTML'>
  <b:widget-settings>
    <b:widget-setting name='content'><![CDATA[<div class="separator" style="clear: both; text-align: center;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgTXIehRPx1mymuZlvDclW-b0A9uD-znatbv_nb0ZJsIuB4l5jA7GKzUwBJVN20c0-wBt9i-WjVacCsLrTn_sd3nVcuOgBeGz1Glr_d0-u8NrxMexXwEw-OXnYtLh4oDcgUYkkax3kiz5eLjr3oAsKktGdITXai40E2ptYbEeWp9VG_r-I4DTUjRZJNov0/s729/PB%20corsi%20e%20percorsi.jpg" style="clear: left; float: left; margin-bottom: 1em; margin-right: 1em;"><a href="https://www.energiacreativa.org/p/contatti-e-cv.html" style="clear: left; float: left; margin-bottom: 1em; margin-right: 1em;"><img border="0" data-original-height="609" data-original-width="729" height="267" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgTXIehRPx1mymuZlvDclW-b0A9uD-znatbv_nb0ZJsIuB4l5jA7GKzUwBJVN20c0-wBt9i-WjVacCsLrTn_sd3nVcuOgBeGz1Glr_d0-u8NrxMexXwEw-OXnYtLh4oDcgUYkkax3kiz5eLjr3oAsKktGdITXai40E2ptYbEeWp9VG_r-I4DTUjRZJNov0/s320/PB%20corsi%20e%20percorsi.jpg" width="320" /></a></a></div><div><br /></div><div><br /></div><br /><div class="separator" style="clear: both; text-align: left;"><a href="https://www.energiacreativa.org/p/contatti-e-cv.html" style="clear: left; margin-bottom: 1em; margin-right: 1em; text-align: center;"><img border="0" data-original-height="237" data-original-width="652" height="116" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjGYknma62-6kktkFJnELfggpEdq87RhH_OFbvbcn3CwMO5aUBeg3W8QubLnAOx0w88HFyjaKFNyVZVSL-aw-9gQf_5TXW3oaJZxqysqmvrFtCL_IAMV9rIedXIM6MyafafuKsc4XuauhbCTyG8QBjEInsilwGFMzojmBJCDDviF4TphfsTWLG5QHZYJfY/s320/CV%202.jpg" width="320" /></a></div>]]></b:widget-setting>
  </b:widget-settings>
  <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
...
<b:widget id='BlogSearch1' locked='false' title='$title=ricerca' type='BlogSearch'>
  <b:includable id='main'>
    <!-- only display title if it's non-empty -->
    <b:if cond='data:title != &quot;&quot;'>
      <h2 class='title'><data:title/></h2>
...
<b:widget id='HTML5' locked='false' title='$title=Percorso individuale' type='HTML'>
  <b:widget-settings>
    <b:widget-setting name='content'><![CDATA[<p></p><div style="text-align: center;"><span style="color: #00cccc;"><b></b></span></div><div class="separator" style="clear: both; text-align: center;"><a href="https://www.energiacreativa.org/p/catalogo-corsi-e-laboratori.html" style="margin-left: 1em; margin-right: 1em;" target="_blank"><img border="0" data-original-height="640" data-original-width="640" height="320" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhReZyJvk8uotacBPC7QwAB_xBz1brrA05Y2qvnG73JJCsJnY47G4AhmWil5GCjbea6HeaMJxM4KBsfsIdc29uzpQbQSTycFWxz67ko468DSUw0YsmKecJqQXxUjfAVgDVdMugie2mhuRc76fS4PLS5_7-NVUEuNQbG2RHTYgjdTsgHwWMDwxIFHh5CHq0/s320/PERCORSO%20INDIVIDUALE%20Quando%20pensi%20troppo%20e%20senti%20poco.Quando%20senti%20troppo%20e%20pensi%20poco.jpgg" width="320" /></a></div><div style="text-align: center;"></div>]]></b:widget-setting>
  </b:widget-settings>
  <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
...
<b:widget id='HTML6' locked='false' title='$title=followit' type='HTML'>
  <b:widget-settings>
    <b:widget-setting name='content'><![CDATA[<style>
.followit--follow-form-container[attr-a][attr-b][attr-c][attr-d][attr-e][attr-f] .form-preview {
  ...
  padding: clamp(17px, 5%, 20px) clamp(17px, 7%, 50px) !important;
  max-width: none !important;
  border-radius: 4px !important;
  box-shadow: 0px 0px rgba(34, 60, 47, 0.25) !important;
}
.followit--follow-form-container[attr-a][attr-b][attr-c][attr-d][attr-e][attr-f] .form-preview,
.followit--follow-form-container[attr-a][attr-b][attr-c][attr-d][attr-e][attr-f] .form-preview *{
...
</style><div class="followit--follow-form-container" attr-a attr-b attr-c attr-d attr-e attr-f><form data-v-291e79e2="" action="https://api.follow.it/subscription-form/SVhURGxocTREem41RWorZ2VZWTRZQWcwbCtRVE1kM2Fmbk40anRvYlVRYVhXZGZKN1drVjN6ODM3Z2FSZEdIR0lDOFpISitsaGV5QkdkSEVSUDUxNzBSY3phSml1ZUtoUFQvTlN1UFJIdWZoZU5jdmsrT0dFWG0rRXoxVVZIL1h8Z0JPbkcvRjQ4bnB6akRESEQ2RXFpTWxYcHBwSTVNd0RtcXR1QVJKbGcvcz0=/8" method="post"><div data-v-291e79e2="" class="form-preview" style="background-color: rgb(255, 255, 255); border-style: solid; border-width: 1px; border-color: rgb(204, 204, 204); position: relative;"><div data-v-291e79e2="" class="preview-heading"><h5 data-v-291e79e2="" style="text-transform: none !important; font-family: Montserrat; font-weight: bold; color: rgb(0, 204, 204); font-size: 16px; text-align: center;">
                  Ricevi nuovi post via email:
                </h5></div> <div data-v-291e79e2="" class="preview-input-field"><input data-v-291e79e2="" type="email" name="email" required="required" placeholder="Inserisci la tua email" spellcheck="false" style="text-transform: none !important; font-family: Montserrat; font-weight: 300; color: rgb(0, 0, 0); font-size: 14px; text-align: center; background-color: rgb(255, 255, 255);" /></div> <div data-v-291e79e2="" class="preview-submit-button"><button data-v-291e79e2="" type="submit" style="text-transform: none !important; font-family: Montserrat; font-weight: bold; color: rgb(241, 250, 250); font-size: 16px; text-align: center; background-color: rgb(0, 204, 204);">
                  Iscriviti
                </button></div></div></form><a href="https://follow.it" class="powered-by-line"> </a></div>]]></b:widget-setting>
  </b:widget-settings>
  <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
...
<b:widget id='HTML7' locked='false' title='$title=expat' type='HTML'>
  <b:widget-settings>
    <b:widget-setting name='content'><![CDATA[<p>&nbsp;</p><div class="separator" style="clear: both; text-align: center;"><div class="separator" style="clear: both; text-align: center;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjjYkXimQlbgCd5q6sWZ8R_XRewVnphUQorcytc2R3Mtku9qb75FYgwA5jQQnquC6n7RtC78oY8zR1-p2pvxtVnLIGDO9e_Ax1B4fXOaJgp5lNR1Ez5Czx-1XzVbYTbY-iYBhqXWRc9sYasF0G7cZCk9gRB2zH3CfedS2NzAeGs4k99nEPjPAK31B-QCRY/s1181/expatriate%20pb.jpg" imageanchor="1" style="margin-left: 1em; margin-right: 1em;"><img border="0" data-original-height="1181" data-original-width="1181" height="320" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjjYkXimQlbgCd5q6sWZ8R_XRewVnphUQorcytc2R3Mtku9qb75FYgwA5jQQnquC6n7RtC78oY8zR1-p2pvxtVnLIGDO9e_Ax1B4fXOaJgp5lNR1Ez5Czx-1XzVbYTbY-iYBhqXWRc9sYasF0G7cZCk9gRB2zH3CfedS2NzAeGs4k99nEPjPAK31B-QCRY/s320/expatriate%20pb.jpg" width="320" /></a></div></div>]]></b:widget-setting>
  </b:widget-settings>
  <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
...
<b:widget id='HTML15' locked='false' title='$title=supervisioni' type='HTML'>
  <b:widget-settings>
    <b:widget-setting name='content'><![CDATA[<p></p><div style="text-align: center;"><span style="color: #00cccc;"><b></b></span></div><div class="separator" style="clear: both; text-align: center;"><a href="https://www.energiacreativa.org/p/catalogo-corsi-e-laboratori.html" style="margin-left: 1em; margin-right: 1em;" target="_blank"><img border="0" data-original-height="640" data-original-width="640" height="320" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhyKzQ9QaN4hWfjX69RD9nqZ7pulbAhoCTwVYugqdNfyM_9CvUifgFc8ZruFbzAE7j7L3HEmHhXIS6Gj87JqRXVJ7Gy0vf6LJBrwyNxOJuuahOu8nFfEbvu7EmMdAojKe_i1-fIAaDi-IJfVr1OLPhTdga1uDIrXqnq3Yy6RL31M-ZLKkvtKw41hwyCovo/s320/PERCORSI%20INDIVIDUALI%20E%20SUPERVISIONI%20ON%20LINE%20Paola%20Bonavolont%C3%A0%20%20%20.jpg" width="320" /></a></div>]]></b:widget-setting>
  </b:widget-settings>
  <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
...
<b:widget id='HTML2' locked='false' title='$title=pic branding scegliere' type='HTML'>
  <b:widget-settings>
    <b:widget-setting name='content'><![CDATA[<p>&nbsp;</p><div class="separator" style="clear: both; text-align: center;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjpZ8dPeU3ofdqQ6i9GHRyDUtaaIX7ykDNtrLModZAyop7Rz7CebTK3widcFnL3DZokVKAFqbuLr8PpOLpLZdG2hPSr_pCs1hZLn5FnhtFiUVEL-yliEVLUK6tQ1ZtS858xpYAp5M155O1KfClEuxYSWLCIrO8FI6T2g1-j7N4M0QzNXP2aQKo39qDjxLM/s1181/Personal%20Branding%20non%20%C3%A8%20vendersi.%20E'%20farsi%20scegliere.jpg" imageanchor="1" style="margin-left: 1em; margin-right: 1em;"><img border="0" data-original-height="1181" data-original-width="1181" height="320" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjpZ8dPeU3ofdqQ6i9GHRyDUtaaIX7ykDNtrLModZAyop7Rz7CebTK3widcFnL3DZokVKAFqbuLr8PpOLpLZdG2hPSr_pCs1hZLn5FnhtFiUVEL-yliEVLUK6tQ1ZtS858xpYAp5M155O1KfClEuxYSWLCIrO8FI6T2g1-j7N4M0QzNXP2aQKo39qDjxLM/s320/Personal%20Branding%20non%20%C3%A8%20vendersi.%20E'%20farsi%20scegliere.jpg" width="320" /></a></div>]]></b:widget-setting>
  </b:widget-settings>
  <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
...
<b:widget id='HTML12' locked='false' title='$title=Personal branding' type='HTML'>
  <b:widget-settings>
    <b:widget-setting name='content'><![CDATA[<p></p><div style="text-align: center;"><span style="color: #00cccc;"><b></b></span></div><div class="separator" style="clear: both; text-align: center;"><a href="https://www.energiacreativa.org/p/catalogo-corsi-e-laboratori.html" style="margin-left: 1em; margin-right: 1em;" target="_blank"><img border="0" data-original-height="640" data-original-width="640" height="320" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi1ekHLv7H9te0Wkwkt0O-MJpdKJzOO60zwD9V_Yff6-XnMP3N8aDbj_RZi3-jxfr6-3JKTI0reM8Kqx7KX3mL4dvXm3WyzBFqagUb8VWIyDU6T_A91nmsQlSNhtU690Gm57kDhU_FbffjUGhTIU1KgnItn-SV-DSEjNUAr6pmmxzqmPb7yh12LswIzWcY/s320/personal%20branding%20individuale.jpg" width="320" /></a></div><div style="text-align: center;"></div>]]></b:widget-setting>
  </b:widget-settings>
  <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
...
<b:widget id='HTML11' locked='false' title='$title=cookie' type='HTML'>
  <b:widget-settings>
    <b:widget-setting name='content'><![CDATA[<p style="line-height: 0.8; margin: 0;">
  <a href="https://www.energiacreativa.org/p/cookies-policy.html" style="margin-bottom: 0; text-align: center;">
    <img border="0" data-original-height="104" data-original-width="547" height="39" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgT9utwOtqV1X5N_sayjEOQjXt8-56QKAxF1UZvVi-w10WX3n4DVvER_MWqth-8z-KCY75TIpJF8EBBdiPSr9dIedRSWArNSf8rDHKRRicmzBPMaCJYNiGVcSY-A1E9Hr0phiC1ND4PW9Dk-6ceQsF2rniCwrEUWm90FtY36OxZnIIRAJS-wIOhirA99kU/w200-h49/Cookies%20and%20Policy%20Privacy.jpg" width="150" style="margin-bottom: 0;" />
  </a>
  <br />
  <span style="font-size: xx-small; line-height: 1.2; margin-top: 0; padding-top: 0;">
    <a href="https://www.energiacreativa.org/p/cookies-policy.html">Cookies e Privacy policy</a><br />
    Blog di Paola Raffaella BonavolontÃ <br />
    Licenza d'uso <br />
    <a href="https://creativecommons.org/licenses/">Attribuzione - Non commerciale - Condividi allo stesso modo</a>
    <a href="https://creativecommons.org/licenses/by-nc-nd/2.5/it/">Licenza Creative Commons Attribuzione - Non commerciale - Non opere derivate.</a><br />
    Puoi condividere sempre tutto ciÃ² che trovi in questo blog lasciando la mia firma.<br />
  ...
  <br />
  <img border="0" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiRBhUuUIaJKSELo93THMk-9emaOjeHq-yK2CjATmmBCPoX7FTEbkNdrjYkc4leALAEVVdM9G6-HGuDmk9QlEJ6URKCLiYb8bZ_x899hw2o0Wswms_vrXj2oitZQ-jtw-T3H4XgcOOlkD8/s100/attribuzione+non+commerciale+condividi+allo+stesso+modo.png" />
</p>

<style>
  /* Rimuovere margini inutili e ridurre spaziatura */
  p {
    margin: 0; /* Rimuove i margini intorno al paragrafo */
  }

  /* Ridurre margini tra l'immagine e il testo */
  p a img {
    margin-bottom: 0 !important; /* Rimuove il margine inferiore dell'immagine */
  }

  /* Ridurre distanza tra righe nel testo */
  span {
    line-height: 1.2 !important; /* Imposta una distanza minore tra le righe di testo */
  }

  /* Rimuovere margine superiore dal testo */
  span a, span br {
    margin-top: 0;
    padding-top: 0;
  }
...
<b:else/>
	...
	<div id='footer'>	
		<b:section class='clear' expr:name='data:blog.url != data:blog.homepageUrl? &quot;&quot; : &quot;Footer Wide&quot;' id='footer-wide'>
<b:widget id='HTML14' locked='false' title='' type='HTML'>
  <b:widget-settings>
    <b:widget-setting name='content'><![CDATA[<span style="clear: left; font-size: xx-small; margin-bottom: 1em; margin-right: 1em;"><img border="0" data-original-height="83" data-original-width="175" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgalbgjclNySpDSmb6GmG9QH0Y4nORFGRwKt_dzePw51lZ-3GRXVto7D_ry-cGkQ3Jdmm9csbOAl_WffS_R6gNny4CzJnU8wCql9PoEUCeUqNHvmnwjXzG1gRxAlglHvyWjh4Y-pUwdgsN_WEDmLBSBy58eor0DFZyVrFj3bF-Hquzk31lGp97_nrgFR5c/s1600/PAOLA%20BONAVOLONTA%20PERSONAL%20BRANDING%20CREATIVO%20ESPERIENZIALE.jpg" /></span>]]></b:widget-setting>
  </b:widget-settings>
  <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
...
<b:if cond='false'><!--amp-enabled-start--></b:if><b:if cond='false and data:blog.pageType in {&quot;static_page&quot;,&quot;item&quot;} and data:blog.isMobileRequest'><b:if cond='false'><!--amp-enabled-end--></b:if>
<b:else/>
<!--scroll-up--><b:if cond='true'><!--scroll-up-->
	<a class='scroll-up shad' href='#'><i class='fa fa-angle-up'/></a>
</b:if>
</b:if>
...
<b:section class='hide' expr:name='data:blog.url != data:blog.homepageUrl? &quot;&quot; : &quot;Admin Footer Custom Code (HTML / JavaScript / CSS)&quot;' id='admin-footer-custom-html-code' maxwidgets='1' showaddelement='no'>
  <b:widget id='HTML200' locked='true' title='Only for Admin' type='HTML' version='1'>
    <b:widget-settings>
      <b:widget-setting name='content'/>
    </b:widget-settings>
    <b:includable id='main'><data:content/></b:includable>
...
<div style='display: none!important'>
	<b:section id='admin-section'>
<b:widget id='ContactForm1' locked='true' title='Modulo di contatto' type='ContactForm' version='1'>
  <b:includable id='main'>
				<form name='contact-form'>
					<div class='contact-form-name-label'><data:contactFormNameMsg/></div>
					<input class='contact-form-name' expr:id='data:widget.instanceId + &quot;_contact-form-name&quot;' name='name' size='30' type='text' value=''/>
					<div class='contact-form-email-label'><data:contactFormEmailMsg/> *</div>
					<input class='contact-form-email' expr:id='data:widget.instanceId + &quot;_contact-form-email&quot;' name='email' size='30' type='text' value=''/>
					<div class='contact-form-email-message-label'><data:contactFormMessageMsg/> *</div>
...
<b:widget id='Label100' locked='true' title='Label Manager' type='Label' version='1'>
  <b:widget-settings>
    <b:widget-setting name='sorting'>ALPHA</b:widget-setting>
    <b:widget-setting name='display'>LIST</b:widget-setting>
    <b:widget-setting name='selectedLabelsList'/>
  ...
  <b:includable id='main'><div id='magone-labels'><b:loop values='data:labels' var='label'><data:label.name/>,<data:label.count/>,</b:loop></div></b:includable>
</b:widget>
</b:section>

	<div id='global-blogger-data'>		
		<div class='languageDirection'><data:blog.languageDirection/></div>
		<div class='pageType'><data:blog.pageType/></div>
		<div class='pageTitle'><b:if cond='data:blog.pageTitle'><data:blog.pageTitle/></b:if></div>
		<div class='pageName'><b:if cond='data:blog.pageName'><data:blog.pageName/></b:if></div>
		<div class='metaDescription'><b:if cond='data:blog.metaDescription'><data:blog.metaDescription/></b:if></div>
		<div class='postImageUrl'><b:if cond='data:blog.postImageUrl'><data:blog.postImageUrl/></b:if></div>
		<div class='postImageThumbnailUrl'><b:if cond='data:blog.postImageThumbnailUrl'><data:blog.postImageThumbnailUrl/></b:if></div>
		<div class='title'><data:blog.title/></div>
		<div class='url'><data:blog.url/></div>
		<div class='homepageUrl'><data:blog.homepageUrl/></div>
		<div class='canonicalHomepageUrl'><b:if cond='data:blog.canonicalHomepageUrl'><data:blog.canonicalHomepageUrl/></b:if></div>
		<div class='canonicalUrl'><b:if cond='data:blog.canonicalUrl'><data:blog.canonicalUrl/></b:if></div>
		<div class='enabledCommentProfileImages'><data:blog.enabledCommentProfileImages/></div>
		<div class='blogId'><data:blog.blogId/></div>
		<div class='encoding'><data:blog.encoding/></div>
	</div>
</div>
...
<div style='display:none!important'>
	...
	<span data-l10n='Not found any posts'>Nessun post </span>	
	<span data-l10n='VIEW ALL'>vedi tutti</span>
	<span data-l10n='Readmore'>leggi</span>
	<span data-l10n='Reply'>Reply</span>
	<span data-l10n='Cancel reply'>Cancel reply</span>
	<span data-l10n='Delete'>Delete</span>
	<span data-l10n='By'>di</span>
	<span data-l10n='Home'>Home</span>
	<span data-l10n='PAGES'>Pagine</span>
	<span data-l10n='POSTS'>POSTS</span>
	<span data-l10n='View All'>vedi tutti</span>
	<span data-l10n='RECOMMENDED FOR YOU'>Potrebbero piacerti</span>
	<span data-l10n='LABEL'>etichette</span>
	<span data-l10n='ARCHIVE'>Archivio</span>
	<span data-l10n='SEARCH'>Cerca</span>
	<span data-l10n='ALL POSTS'>Tutti gli articoli</span>
	<span data-l10n='Not found any post match with your request'>Nessun post</span>
...
<div class='search-form-wrapper'>
	...
	<form action='/search' class='search-form' method='get'>
		<label class='search-form-label'><span data-l10n='Type something and Enter'>digita la tua ricerca e clicca invio</span></label>
...
<!--var-SliderAnimateIn-start--><b:with value='&quot;inherit&quot;' var='SliderAnimateIn'><!--var-SliderAnimateIn-end-->
<!--var-SliderAnimateOut-start--><b:with value='&quot;inherit&quot;' var='SliderAnimateOut'><!--var-SliderAnimateOut-end-->
<b:if cond='data:SliderAnimateIn != &quot;inherit&quot; or data:SliderAnimateOut != &quot;inherit&quot;'>
<!-- SLIDER ANIMATION PICKER -->
<script type='text/javascript'>
var SliderAnimateIn = &#39;<data:SliderAnimateIn/>&#39;;
var SliderAnimateOut = &#39;<data:SliderAnimateOut/>&#39;;
</script>
<style type='text/css'>
...
var SNEEIT_LICENSE = "ms3Qms8-fcw9P3Qms-0wic8w3Qm-4ss0oQ3Q3-PPP93PwXo-3w09P4J8w-XQftmsP3m-93s0o9P8w-mJmsP39P9-8oPms8w9P-it3Qftic9P8wmsic";/*LICENSE KEY YOU GOT FROM SNEEIT.COM*/
...
var DEFAULT_POST_THUMBNAIL = 'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi_5CLeQA4cRJ-7lJn0Db1zG-057QwORFGuLfyzVqJG1jiN5uIGgNddnhs9KAW17_im-8_0ATE9GiywMjVgTHIwBqPQprFH3vydTfLWzb7M-LFeExxqEcNGgRcrT1kUEoSj_5z1BWQkqxs/w274-h248-rw/';// leave blank to use random images for non-thumbnail posts
...
"License and API Keys": {
	"Sneeit License Key": {
		"start": "var SNEEIT_LICENSE = \"",
		"end": "\";/*LICENSE KEY YOU GOT FROM SNEEIT.COM*/",
		"default": "",		
		"desc": "Login to your Sneeit Account and access Sneeit License on your author dashboard to generate your key"
	}
},
"General Styles": {
	"Main Color": {
		"start": "<Variable name=\"keycolor\" description=\"Main Color\" type=\"color\" default=\"#FF3D00\" value=\"",
		"end": "\"/>",
		"type": "color",
		"default": "#FF3D00",		
		"desc": "Color of links and important things. You can change in Theme / Customize also"
	}
	, 
	"Body Text Font": {
		"start": "<Variable name=\"body.font\" description=\"Font\" type=\"font\" default=\"normal normal 12px 'Roboto', sans-serif\" value=\"",
		"end": "\"/>",
		"type": "font",
		"default": "normal normal 12px 'Roboto', sans-serif",		
		"desc": "Font style for all texts in general"
	}
		
	, 
	"Body Text Color": {
		"start": "<Variable name=\"body.text.color\" description=\"Text Color\" type=\"color\" default=\"#000000\" value=\"",
		"end": "\"/>",
		"type": "color",
		"default": "#000000",		
		"desc": "Color all texts in your site. You can change in Theme / Customize also"
	}	
	, 
	"Body Background Color": {
		"start": "<Variable name=\"body.background.color\" description=\"Body Background\" type=\"color\" default=\"#efefef\" value=\"",
		"end": "\"/>",
		"type": "color",
		"default": "#efefef",
		"desc": "Background color of your site. You can change in Theme / Customize also"
	}
	, 
	"Header Background Color": {
		"start": "<Variable name=\"header.background.color\" description=\"Header Background\" type=\"color\" default=\"#ffffff\" value=\"",
		"end": "\"/>",
		"type": "color",
		"default": "#ffffff",		
		"desc": "Background color of your site header"
	}
	, 
	"Content Background Color": {
		"start": "<Variable name=\"content.background.color\" description=\"Entire Blog Background\" type=\"color\" default=\"#efefef\" value=\"",
		"end": "\"/>",
		"type": "color",
		"default": "#efefef",		
		"desc": "Background color of the area where your post content appears"
	}
	, 
	"Link Text Color": {
		"start": "<Variable name=\"link.color\" description=\"Link Color\" type=\"color\" default=\"$(keycolor)\" value=\"",
		"end": "\"/>",
		"type": "color",
		"default": "#FF3D00",		
		"desc": "Text color of the links in your site"
	}	
	, 
	"Visisted Link Text Color": {
		"start": "<Variable name=\"link.visited.color\" description=\"Visited Color\" type=\"color\" default=\"#EA3A00\" value=\"",
		"end": "\"/>",
		"type": "color",
		"default": "#EA3A00",		
		"desc": "Text color of the visited links in your site"
	}	
	, 
	"Hover Link Text Color": {
		"start": "<Variable name=\"link.hover.color\" description=\"Hover Color\" type=\"color\" default=\"#FF4D11\" value=\"",
		"end": "\"/>",
		"type": "color",
		"default": "#FF4D11",		
		"desc": "Text color of the hovering links in your site"
	}	
	, 
	"Hover Thumbnail Background Image": {
		"start": "<Variable name=\"blockitembghv\" description=\"Background of Items in Blocks when Hover\" type=\"color\" default=\"#000000\" value=\"",
		"end": "\"/>",
		"type": "color",
		"default": "#000000",		
		"desc": "background color of the post thumbnails in article blocks when the mouse hovers on it"
	}	
	, 
	"Main Menu Text Font": {
		"start": "<Variable name=\"menufont\" description=\"Menu Main Items Font\" type=\"font\" default=\"normal bold 14px 'Roboto', sans-serif\" value=\"",
		"end": "\"/>",
		"type": "font",
		"default": "normal bold 14px 'Roboto', sans-serif",		
		"desc": "Font style for texts in main menu"
	}
	, 
	"Main Menu Text Color": {
		"start": "<Variable name=\"menucolor\" description=\"Menu Main Items Color\" type=\"color\" default=\"#000000\" value=\"",
		"end": "\"/>",
		"type": "color",
		"default": "#000000",		
		"desc": "Color of all texts in your site main menu"
	}
	, 
	"Main Menu Text Hover Color": {
		"start": "<Variable name=\"menucolorhover\" description=\"Menu Main Items Hover Color\" type=\"color\" default=\"#777777\" value=\"",
		"end": "\"/>",
		"type": "color",
		"default": "#777777",		
		"desc": "Color of all texts in your site main menu when mouse hovering on"
	}
	, 
	"Main Menu Background Color": {
		"start": "<Variable name=\"menubackground\" description=\"Menu Main Items Background\" type=\"color\" default=\"#ffffff\" value=\"",
		"end": "\"/>",
		"type": "color",
		"default": "#ffffff",		
		"desc": "Background color of main menu (not the whole header)"
	}
	, 
	"Main Menu Background Hover Color": {
		"start": "<Variable name=\"menubackgroundhover\" description=\"Menu Main Items Hover Background\" type=\"color\" default=\"#ffffff\" value=\"",
		"end": "\"/>",
		"type": "color",
		"default": "#ffffff",		
		"desc": "Background color of main menu items when mouse hovering on them"
	}
	, 
	"Sub Menu Text Color": {
		"start": "<Variable name=\"menusubcolor\" description=\"Menu Sub Items Color\" type=\"color\" default=\"#cccccc\" value=\"",
		"end": "\"/>",
		"type": "color",
		"default": "#cccccc",		
		"desc": "Color of texts in sub menu"
	}
	, 
	"Sub Menu Text Hover Color": {
		"start": "<Variable name=\"menusubcolorhover\" description=\"Menu Sub Items Hover Color\" type=\"color\" default=\"#ffffff\" value=\"",
		"end": "\"/>",
		"type": "color",
		"default": "#ffffff",		
		"desc": "Color of texts in sub menu when mouse hovering"
	}
	, 
	"Sub Menu Background Color": {
		"start": "<Variable name=\"menusubbackground\" description=\"Menu Sub Items Background\" type=\"color\" default=\"#333333\" value=\"",
		"end": "\"/>",
		"type": "color",
		"default": "#333333",		
		"desc": "background color of sub menu items"
	}
	, 
	"Selected Main Menu Text Color": {
		"start": "<Variable name=\"menucurcolor\" description=\"Selected Menu Main Item Color\" type=\"color\" default=\"#FFFFFF\" value=\"",
		"end": "\"/>",
		"type": "color",
		"default": "#FFFFFF",		
		"desc": "Text color of the current seletected main menu item"
	}
	, 
	"Selected Main Menu Background Color": {
		"start": "<Variable name=\"menucurbackground\" description=\"Selected Menu Main Item Background\" type=\"color\" default=\"#FF3D00\" value=\"",
		"end": "\"/>",
		"type": "color",
		"default": "#FF3D00",		
		"desc": "Background color of the current selected main menu item"
	}
	, 
	"Article Widget Title Font": {
		"start": "<Variable name=\"feedwid.title.font\" description=\"Article Widgets Title\" type=\"font\" default=\"normal bold 23px 'Roboto', sans-serif\" value=\"",
		"end": "\"/>",
		"type": "font",
		"default": "normal bold 23px 'Roboto', sans-serif",		
		"desc": "Font style for title of article widgets"
	}
	, 
	"Sidebar Widget Title Font": {
		"start": "<Variable name=\"sidewid.title.font\" description=\"Right Sidebar Widgets Title\" type=\"font\" default=\"normal normal 16px 'Roboto', sans-serif\" value=\"",
		"end": "\"/>",
		"type": "font",
		"default": "normal normal 16px 'Roboto', sans-serif",		
		"desc": "Font style for sidebar widget title"
	}
	, 
	"Post Title Font": {
		"start": "<Variable name=\"post.title.font\" description=\"Post Title\" type=\"font\" default=\"normal normal 40px 'Roboto', sans-serif\" value=\"",
		"end": "\"/>",
		"type": "font",
		"default": "normal normal 40px 'Roboto', sans-serif",		
		"desc": "Font style for Single Post Title"
	}
	, 
	"Post Body Text Font": {
		"start": "<Variable name=\"post.body.font\" description=\"Post Body\" type=\"font\" default=\"normal normal 16px 'Roboto', sans-serif\" value=\"",
		"end": "\"/>",
		"type": "font",
		"default": "normal normal 16px 'Roboto', sans-serif",		
		"desc": "Font style for Single Post Body Texts"
	}
	, 
	"Slider Title Font": {
		"start": "<Variable name=\"slider.title.font\" description=\"Slider Item Title\" type=\"font\" default=\"normal 400 30px 'Roboto', sans-serif\" value=\"",
		"end": "\"/>",
		"type": "font",
		"default": "normal 400 30px 'Roboto', sans-serif",		
		"desc": "Font style for Slider Titles"
	}
},
"Site Layout": {
	"Entire Site Width": {
...
"Post Content": {
	...
	"Feature Images Resize": {
		"start": "var FEATURE_IMAGES_RESIZE = ",
		"end": "; // resize feature images to match with #content width",
		"type" : "checkbox",
		"default": true,		
		"check": true,
		"uncheck": false,
		"desc": "Resize Feature image to match with #content width"
	},
	"Disable BreadCrumb": {
	...
	"Enable Table of Content": {
		"start": "var TABLE_OF_CONTENT = '",
		"end": "'; // enable table of content for posts which have more than one H2",
		"type" : "select",
		"choice" : {
			"none" : "Not display",
			"right" : "Show on Right Side of Post",
			"left" : "Show on Left Side of Post",
			"full" : "Show as Full Width as Post"
		},
		"default": "none",		
	...
	"Related Post Source": {
		...
		"choice" : {
			...
			"disable" : "Not Show Related Posts"
		}
	},
...
"SEO and Page Speed": {	
	"Loading Image": {
		"start": "<!--main-loader-start--><b:with value='&quot;",
		"end": "&quot;' var='loading_image'><!--main-loader-end-->",
		"default": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg98Jr0XxfXqayYWn3RTw9LwFvxo-2Rd2TJYmTOhS1s6rOZKDacWx2UpyPUx3Uk2Bm84drR3IpNk55gCXhImy4i5VAP0XoJ_iOe1JS4L_qlmYggmaUUjGlcP_oDDM9pQ9LAIab0FuITCkJ6/s95-rw/loading.webp",
		"desc": "Leave blank to disable (will increase CLS). The animated image that you want to use for loading icon when page loads. "
	},
	...
	"Convert / Replace Images to .Webp": {
		"start": "var REPLACE_IMAGE_TO_WEBP = ",
		"end": "; // replace all Blogger hosted image to .webp images to save the loading time",
		"type" : "checkbox",
		"default": true,
		"check": true,
		"uncheck": false,
		"desc": "Replace all Blogger hosted image to *.webp images to save the loading time. Disable this may lead to bad in Core Web Vital measurement"
	}
},
"Mobile Template": {
	"Mobile Sticky Menu": {
	...
	"Enable AMP for Mobile": {
		...
		"actions" : {
			"true" : [
				{
					"replace" : "<b:attr cond='(data:blog.pageType in {&quot;static_page&quot;,&quot;item&quot;}) and data:blog.isMobileRequest' name='amp' value='amp'/>",
					"with" : ""
				},
				{
					"replace_tag" : "html",
					"with" : "<html b:version='2' class='v2' expr:dir='data:blog.languageDirection' expr:lang='data:blog.locale'><b:attr cond='(data:blog.pageType in {&quot;static_page&quot;,&quot;item&quot;}) and data:blog.isMobileRequest' name='amp' value='amp'/>"
				}
			],
			"false" : [
				{
...
"main_menu": {
	...
	"fields" : {
		...
		"icon": {
			"title": "Menu Icon",
			"desc": "Check code at <a href=\"https://fontawesome.com/v4.7.0/icons/\" target=\"_blank\">FontAwesome Icon Code</a>"
		}
	}
}
SNEEIT-THEME-MENUS
...
"nytimes": {
	"title" : "NYTimes",
	"preview": "http://magonedemo.blogspot.com/2000/09/the-new-york-times.html",
	"thumb": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiLoGl5NbWdGZ4wljdo_fM_Waz6DvjAdiBfLvf602AUEyGHW6Ek5q8ZZmbJk-6r0Fwe7F8pY3Bj3pzqIXP3ai-27bkxgL6SIQcWvDHQ9nEZ3NepfsmzpaCkEP4sU0PnWwES9hvjk_AQGld9/s1600/02-NYTimes.jpg",
	"data" : {
		"settings": {
...
"flatnews": {
	"title" : "FlatNews",
	"preview": "http://magonedemo.blogspot.com/2000/09/adapted-flatnews.html",
	"thumb": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjGeUZN1dY8geeKBpVDOI7a8SadgtWHgKnUAR3YoLnAfylFp_r1gN4Hjhx8SUBO1l9Ob908XLN2KJKLEWB7oQvLQZdJHo1KXZAYS94SGN8SA-Es34IftYVYvVC4uGDYVvY5Y9LKkx7DgN7i/s1600/03-flatnews.jpg",	
	"data" : {
		"settings": {
			"Auto Height Logo": true,
			"Move Social and Search Icons to Top of Page": true
		...
		"variables": {
			...
			"body.background" : "$(color) url(https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhSjjZOhCzGTOV-KWM8d8ZH5U9tI1iqPxAW0Ifw1Xdlb072pD43pm6G_2T2PNYe4HRPvCwKXPiuM5hq1T8p4VAbJlWXI7oOQVz51yT5zmjYwgyKZy5d1Y-l7Hs3BN0YK7THWRyepCsYl1rI/s0-r/bg-61.jpg) repeat fixed top left",
			"link.color" : "#d12F2F",
...
"sahifa": {
	"title" : "Sahifa",
	"preview": "http://magonedemo.blogspot.com/2000/09/sahifa-best-magazine-wordpress-theme.html",
	"thumb": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEji_xlY8_sN5AqBttcO_7V35bg8gwicjvKmL2JwfYlBddj7295z3VBGRamGhL21EFWmPGQvbQaG9zSHrFhsbXb8tQzrX-qj_6zbe7iETygrtR7c4FR6PrCEDdI4WWF2daIEv46tFb6mgWIO/s1600/04-sahifa.jpg",
	"data" : {
		"settings": {
			"Auto Height Logo": true,
			"Move Social and Search Icons to Top of Page": true
		...
		"variables": {
			...
			"body.background" : "$(color) url(https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiPTql1i7mJe7QD4SClIAstIlMGvt8_zUdhpYvbogBDjPitPcpjPAcegLf0qhpJMaL-s5jkuT5VAbsSTPyhyphenhyphenp6yo2eI2hHlNY3QhQSNk0v5fZwjpqERH4sioVDorHOcIOSSo9YVtceG5Bbc/s0/body-bg7%255B1%255D.png) repeat fixed top left",
			"keycolor" : "#F88C00",
			"link.color" : "#F88C00",
...
"sevida": {
	"title" : "Sevida",
	"preview": "http://magonedemo.blogspot.com/2000/09/adapted-sevida-second-best-seller.html",
	"thumb": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhfbEPx2U1I19VHt6bgbbBjfoGiKheOtXW_HAITAb8MFeQ_-gTvLsXOgsOKYBFprDY5XqXR1CEWuvrmQVbwVQ0CoKMzrjnp3302tqNNbkCa0SrYH78JiVo6yVmEVdFLOiBuvFBhKkoc-N-F/s1600/05-sevida.jpg",
	"data" : {
		"settings": {
			"Auto Height Logo": true,
			"Move Social and Search Icons to Top of Page": true
...
"tech": {
	"title" : "Tech Geekers",
	"preview": "http://magonedemo.blogspot.com/2015/08/layout-techno-spot.html",
	"thumb": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg5CDkHERIsYG_22NYwbCjxk6mLk77f-exEim4O0En57nCZuLlApTRrsz5Ge7wUMrB_foyzMJ2rEzJ_9flQdeY8hEUhol8QztvbdWkJ3Y1vuJX73Dz56idRGRRaawYqxG7zzzjWAyX5gAFy/s1600/06-tech-geekers.jpg",
	"data" : {
		"widgets": {
			"header-wide" : [
				{	"type" : "Label",
...
"elegant": {
	"title" : "Elegant Pack",
	"preview": "http://magonedemo.blogspot.com/2000/08/elegant-pack-layout.html",
	"thumb": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhGj4zEIzsNBKjhQ4dE6jrIpgfBucPhGzqU8IMxfBvpNdRH3WNZ7x52MX7UQU7g7rYpJFc2F_CnR1m4QYpYOi1SgYoc77gsOs4Gz_rQlnClmag49mFy7DHD1v5cVKd-DFBAEn5kThM_DgIw/s1600/07-elegant-pack.jpg",
	"data" : {
		"widgets": {
			"header-wide" : [
				{	"type" : "Label",
...
"stylish": {
	"title" : "Stylish Zine",
	"preview": "http://magonedemo.blogspot.com/2000/08/layout-stylish-zine.html",
	"thumb": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhYpILIXMi0Lgfafb4sGThuoXxfi2SrDNkR2rOqoLq7Bn34ZsrjQ8d7IQTmyhXZHSpypiIET3Gk0vbIgIxRIxDZ4JnvYnGagcUtTqmW5UTpGb_NqOFUkbnlAiwS191eg8yGR0vcAH0jtUKb/s1600/08-stylish-zine.jpg",
	"data" : {		
		"widgets": {
			"header-wide" : [
				{	"type" : "Label",
...
"minimal": {
	"title" : "Minimal Times",
	"preview": "http://magonedemo.blogspot.com/2000/08/layout-minimal-times.html",
	"thumb": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhNFfjS-nAW7mSXgHoPXhyphenhyphenmbKuYGJ2utA9sN4dsFb70w7kCMgyl2ACOc7UaN9_eif2UaQwnUuoQBq_xArFPff48zdjCXb5RyP0Mq9_7OvErhvOIadiCsskE1AVe3qXPvDWT4qUDynpUur_K/s1600/09-minimal-times.jpg",
	"data" : {
		"widgets": {
			"header-wide" : [
				{	"type" : "Label",
...
"affiliate": {
	...
	"preview": "http://magonedemo.blogspot.com/2000/08/layout-affiliate-marketers.html",
	"thumb": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg1T37IMp6lrl8OLGK73jvT7sivbRtPOez9M0Bpc11JU04A0gNUDqMDYaxxTSNo-pffv9FNqwn3UV4cWGzfIMnLXmU4ER2_NYmwBvWWM-vj6w-ai1upuBe3QJwskruxxaUHVTs7sdN8qUF_/s1600/10-affiliate-marketers.jpg",
	"data" : {
		"widgets": {
			"header-wide" : [
				{	"type" : "HTML"
...
"dairy": {
	"title" : "Dairy Notes",
	"preview": "http://magonedemo.blogspot.com/2000/08/layout--dairy-notes.html",
	"thumb": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiPG-atSnnlp4UhJHkJaYYI3hxBJ_hmUZMmwHzJoJVqMrPWKxHS_4OjvUqiKy8w1hnk42FGuXKVgB1dLiO0GfiELRV7C-FPMr67LttwVHi4MWVy5yD3H6ax5U8UisZwSPgwEfx3AZl3x8Vf/s1600/11-diary-notes.jpg",
	"data" : {
		"widgets": {
			"header-wide" : [
			],
...
"writer": {
	...
	"preview": "http://magonedemo.blogspot.com/2000/08/layout-absolute-writers.html",
	"thumb": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgqCbNynfpj3d0i9_MiS-IxHWrWPO-cFYiDUbOp6xC-NocjfSYv07-jmJ2Q7uHwRg0y75tIMQoRpSZB7AB_zM2poXnY76eS8FrtmFnC5hDJU1KBheyIizJHwKDQhV4olYmN7WU6WbccexTF/s1600/12-absolute-writer.jpg",
	"data" : {
		"widgets": {
			"header-wide" : [
				{	"type" : "Label",
...
"financial": {
	...
	"preview": "http://magonedemo.blogspot.com/2000/08/layout-financial-ist.html",
	"thumb": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgXOzTGfsvTEfnCFcW0LhfCGCFShOEJ1J7sViDpXHgcERkz2Fj7qtxfOu8vlUNjH1EYpuk4zoIsav96awYrIDR7yzsQ_WRpfbtFApSeQAX2jo0bQ2Tm4SRhbnotVvZn01x7h6fTYfHje14Q/s1600/13-financial-list.jpg",
	"data" : {
		"widgets": {
			"header-wide" : [
			],
...
"grid": {
	"title" : "Random Grids",
	"preview": "http://magonedemo.blogspot.com/2000/08/layout-random-grids.html",
	"thumb": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg6oQxu_TmnPm_2YqVMJSuVVg9Qyv1j0D3E4rFZUSLTyy-xCksf3ZpECMbz3J_7-YyXMLY3fXu7Pvuug5T8S8gsdcKYNRRoVGQ4cH0qjaT5LYXGPDKoV0J7CEeSh2M6pfWlhUgvTsPuJ1vK/s1600/14-random-grids.jpg",
	"data" : {
		"settings": {
...
"blocks": {
	...
	"preview": "http://magonedemo.blogspot.com/2000/08/layout-working-blocks.html",
	"thumb": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhR0xnC5q-Fj-_y6pQp9C3Iow7TDNLpFFYN9iBVl2yLPedwSScof6tW25qkFxSvchPQ4lombvqbFVQ-U3Gf7g4DFP_EbDnH8jOKUyOJ7yD1Afxm9X92L9jAMAp-989nuwh1SdaQXva-x9xr/s1600/15-working-blocks.jpg",
	"data" : {
		"settings": {
			"Home Page Sidebar": "none"
		},
...
"showcase": {
	...
	"preview": "http://magonedemo.blogspot.com/2000/08/layout-showcase-palette.html",
	"thumb": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgth-Z-nnjZwJNGVMy51-9fgWjS_QnVyOUJ4aPkk1pQ_DcWrtzsu6JyglNPdcjancgZViXD7KVvsukIxN04n1yZfqbhvZXBoo40iMuFGQze3RZNV9Ak7rVlIVpKu2Iktst5HLMbUWkB6nn9/s1600/16-showcase-palette.jpg",
	"data" : {
		"settings": {
			"Home Page Sidebar": "none"
		},
...
"fluid": {
	"title" : "Fluid Stacks",
	"preview": "http://magonedemo.blogspot.com/2000/08/layout-fluid-stacks.html",
	"thumb": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiQNMG1r1V112T-B00Oe4FtuOXlII8LmVJCvdUXmwgT3mnKrnQeA95xlw5p68cZroZWV-KtcYSIXldX6tvEQjr23w8V9IpB3-mofDZTFB3n6Yc-qaEwsNPPmA5dYrUcSuMim0hQeQGIPdxM/s1600/17-fluid-stacks.jpg",
	"data" : {
		"settings": {
			"Home Page Sidebar": "none"
		},
